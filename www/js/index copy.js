...
$(".cls-pageregister-form-div input").focus(function() {
    $(".cls-pageregister-warning p").attr("style", "display:none").fadeOut(500);
});
...
$(document).on('pageshow', '#id-page-fail', function(e) {
    ...
    $('#id-pagefail-text2 p').text(JSON.parse(window.localStorage.getItem("faveu_response")).faveun);
...
$(document).on('pageshow', '#id-page-success', function(e) {
    ...
    e.preventDefault();
    var useravatar = JSON.parse(window.localStorage.getItem("faveu_response")).usera;
    $('#id-pagesuc-text2 p').text(JSON.parse(window.localStorage.getItem("faveu_response")).faveun);
...
$(document).on('pageshow', '#id-page-success1', function(e) {
    ...
    e.preventDefault();
    $('#id-pagesuc1-text2 p').text(JSON.parse(window.localStorage.getItem("faveu_response")).faveun);
});
...
$(document).on('pagebeforeshow', '#id-page-com', function(e) {
    ...
    $('.cls-pagecom-inputtext p').text(input_text_temp);
    animation_f();
