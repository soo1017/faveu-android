...
$(document).on('pagebeforeshow', '#id-page-6', function (e) {
    // galaxy
    if ($('.cls-page6-envelopecard').css('top') == top_px.galaxy_top) {
        positionEnvelope('-561');
        // positionEnvelope('-553');
    } else if ($('.cls-page6-envelopecard').css('top') == top_px.galaxytab_top) {
        positionEnvelope('-430');
...
$(document).on('tap', '.cls-outer11, .cls-outer22, .cls-outer33, .cls-outer44, .cls-outer55',  function(e) {
    ...
    /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% galaxy, galaxytab */
    if ($('.cls-page6-envelopecard').css('top') == top_px.galaxy_top) {
        selectRightEnvelopeToOpen(dom_element, 'galaxy');
    } else if ($('.cls-page6-envelopecard').css('top') == top_px.galaxytab_top) {
        selectRightEnvelopeToOpen(dom_element, 'galaxytab');
    // } else if ($('.cls-page6-envelopecard').css('top') == top_px.iPhX_top) {
...
$(document).on('tap', '.cls-bot-left-right11, .cls-bot-left-right22, .cls-bot-left-right33, .cls-bot-left-right44, .cls-bot-left-right55',  function(e) {
    ...
    // } else 
    if ($('.cls-page6-envelopecard').css('top') == top_px.galaxy_top) {
        if ( ($(invite_11).css('top') == high_px.galaxy_high_px) 
                || ($(invite_22).css('top') == high_px.galaxy_high_px) 
                || ($(invite_33).css('top') == high_px.galaxy_high_px) 
                || ($(invite_44).css('top') == high_px.galaxy_high_px) 
                || ($(invite_55).css('top') == high_px.galaxy_high_px) ){
            selectEnvelopeToClose(dom_element, 'galaxy');
        }
    } else if ($('.cls-page6-envelopecard').css('top') == top_px.galaxytab_top) {
        if ( ($(invite_11).css('top') == high_px.galaxytab_high_px) 
                || ($(invite_22).css('top') == high_px.galaxytab_high_px) 
                || ($(invite_33).css('top') == high_px.galaxytab_high_px) 
                || ($(invite_44).css('top') == high_px.galaxytab_high_px) 
                || ($(invite_55).css('top') == high_px.galaxytab_high_px) ){
            selectEnvelopeToClose(dom_element, 'galaxytab');
        }
    // } else if ($('.cls-page6-envelopecard').css('top') == top_px.iPhX_top) {
...
$(document).on('pageshow', '#id-page-7', function(e) {
    ...
    function Enevelopeclose_215px(callback) {
        ...
        // $(flyingcard_selector).css('top', '295px');
...
$(document).on('pageshow', '#id-page-fail', function(e) {
    ...
    $('#id-pagefail-text2 h4').text(JSON.parse(window.localStorage.getItem("faveu_response")).faveun);
...
$(document).on('pageshow', '#id-page-success', function(e) {
    ...
    e.preventDefault();
    var useravatar = JSON.parse(window.localStorage.getItem("faveu_response")).usera;
    $('#id-pagesuc-text2 h4').text(JSON.parse(window.localStorage.getItem("faveu_response")).faveun);
...
$(document).on('click', '#id-pagesucchat1-switch-link', function(e) {
    e.preventDefault();
    if ($('#id-pagesucchat1-switch-link p').text() === 'CREATE') {
        $('#id-pagesucchat1-switch-link p').text('JOIN')
        $('#id-pagesucchat-btn').text('CREATE')
        $('.cls-pagesucchat-form-subdiv3').addClass('cls-pagesucchat-form-subdiv3-block');
        setTimeout(function () {
            $('.cls-pagesucchat-form-subdiv3').addClass('cls-pagesucchat-form-subdiv3-opacity');
        ...
        $('#id-pagesucchat1-switch-link p').text('CREATE')
        $('#id-pagesucchat-btn').text('JOIN')
        $('.cls-pagesucchat-form-subdiv3').removeClass('cls-pagesucchat-form-subdiv3-block');
        setTimeout(function () {
            $('.cls-pagesucchat-form-subdiv3').removeClass('cls-pagesucchat-form-subdiv3-opacity');
        }, 500);
    }
});
...
$(document).on('click', '#id-pagesuctext-btn2', function(e) {
    ...
    if ($('#id-pagesuctext-btn2').text() === 'CONFIRM') {
        ...
        $(this).prop('disabled', false);
        $('#id-pagesuctext-btn2').text("LET'S DO IT!")
    } else {
