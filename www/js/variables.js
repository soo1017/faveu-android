...
// Page 6 Envelope
const top_px = {galaxy_top: '-120px', galaxytab_top: '-40px'};
// const top_px = {iPh5_top: '-110px', iPh67_top: '-120px', iPh67s_top: '-130px', iPhX_top: '-111px', iPad_top: '-80px'};
const low_px = {galaxy_low_px: '180px', galaxytab_low_px: '190px'};
// const low_px = {iPh5_low_px: '161px', iPh67_low_px: '180px', iPh67s_low_px: '195px', iPhX_low_px: '175px', iPad_low_px: '190px'};
const high_px = {galaxy_high_px: '30px', galaxytab_high_px: '20px'};
